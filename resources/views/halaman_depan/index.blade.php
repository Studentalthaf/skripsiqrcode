...
<html lang="en">
    <head>
        ...
        <title>PUNYA ALTHAF SKRIPSI</title>
        <link rel="stylesheet" type="text/css" href="{{ asset('halaman_depan/css/bootstrap.min.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('halaman_depan/css/font-awesome.min.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('halaman_depan/css/bistro-icons.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('halaman_depan/css/animate.min.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('halaman_depan/css/settings.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('halaman_depan/css/navigation.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('halaman_depan/css/owl.carousel.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('halaman_depan/css/owl.transitions.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('halaman_depan/css/jquery.fancybox.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('halaman_depan/css/zerogrid.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('halaman_depan/css/style.css') }}">
        <link rel="shortcut icon" href="{{ asset('halaman_depan/images/favicon.png') }}">
    </head>

<body>

    <!--Loader-->
    @include('halaman_depan.include.loader')
    <!--Header-->
    @include('halaman_depan.include.header')
  ...
  <div id="rev_slider" class="rev_slider"  data-version="5.0">
    ...
    <!-- SLIDE  -->
      <li data-transition="fade">
        <!-- MAIN IMAGE -->
        <img src="{{ asset('halaman_depan/images/hom2-banner1.jpg ') }}" alt="" data-bgposition="center center" data-bgfit="cover">							
       <!-- LAYER NR. 1 -->
      ...
      <li data-transition="fade text-center">
        <img src="{{ asset('halaman_depan/images/hom2-banner2.jpg ') }}"  alt="" data-bgposition="center center" data-bgfit="cover">	
       <h1 class="tp-caption tp-resizeme text-center" 
                          data-x="center" data-hoffset="15"
                          data-y="170" 
                          data-transform_idle="o:1;"
          ...
          <div class="wrap-content clearfix home-gallery">
            ...
            <div class="col-1-4 mix work-item starters">
              <div class="wrap-col">
                <div class="item-container">
                  <div class="image">
                    <img src="{{ asset('halaman_depan/images/galler2.jpg') }}" alt="cook"/>
                    <div class="overlay">
                        <a class="fancybox overlay-inner" href="{{ asset('halaman_depan/images/galler2.jpg') }}" data-fancybox-group="gallery"><i class=" icon-eye6"></i></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-1-4 mix work-item dinner">
              <div class="wrap-col">
                <div class="item-container">
                  <div class="image">
                    <img src="{{ asset('halaman_depan/images/gallery3.jpg') }}" alt="cook"/>
                    <div class="overlay">
                        <a class="fancybox overlay-inner" href="{{ asset('halaman_depan/images/gallery3.jpg') }}" data-fancybox-group="gallery"><i class=" icon-eye6"></i></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-1-4 mix work-item drinks">
              <div class="wrap-col">
                <div class="item-container">
                  <div class="image">
                    <img src="{{ asset('halaman_depan/images/gallery4.jpg') }}" alt="cook"/>
                    <div class="overlay">
                        <a class="fancybox overlay-inner" href="{{ asset('halaman_depan/images/gallery4.jpg ') }}" data-fancybox-group="gallery"><i class=" icon-eye6"></i></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-1-4 mix work-item dinner">
              <div class="wrap-col">
                <div class="item-container">
                  <div class="image">
                    <img src="{{ asset('halaman_depan/images/gallery5.jpg ') }}" alt="cook"/>
                    <div class="overlay">
                        <a class="fancybox overlay-inner" href="{{ asset('halaman_depan/images/gallery5.jpg') }}" data-fancybox-group="gallery"><i class=" icon-eye6"></i></a>
                    </div> 
                  </div>
                </div>
              </div>
            ...
            <div class="col-1-4 mix work-item lunch">
              <div class="wrap-col">
                <div class="item-container">
                  <div class="image">
                    <img src="{{ asset('halaman_depan/images/gallery6.jpg') }}" alt="cook"/>
                    <div class="overlay">
                        <a class="fancybox overlay-inner" href="{{ asset('halaman_depan/images/gallery6.jpg') }}" data-fancybox-group="gallery"><i class=" icon-eye6"></i></a>
                    </div>
                  </div> 
                </div>
              </div>
            ...
            <div class="col-1-4 mix work-item starters">
              <div class="wrap-col">
                <div class="item-container">
                  <div class="image">
                    <img src="{{ asset('halaman_depan/images/gallery7.jpg ') }}" alt="cook"/>
                    <div class="overlay">
                        <a class="fancybox overlay-inner" href="{{ asset('halaman_depan/images/gallery7.jpg ') }}" data-fancybox-group="gallery"><i class=" icon-eye6"></i></a>
                    </div>
                  </div> 
                </div>
              </div>
...
<script src="{{ asset('halaman_depan/js/jquery-2.2.3.js') }}" type="text/javascript"></script>
<script src="{{ asset('halaman_depan/js/bootstrap.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('halaman_depan/js/jquery.themepunch.tools.min.js') }}"></script>
<script src="{{ asset('halaman_depan/js/jquery.themepunch.revolution.min.js') }}"></script>
<script src="{{ asset('halaman_depan/js/revolution.extension.layeranimation.min.js') }}"></script>
<script src="{{ asset('halaman_depan/js/revolution.extension.navigation.min.js') }}"></script>
<script src="{{ asset('halaman_depan/js/revolution.extension.parallax.min.js') }}"></script>
<script src="{{ asset('halaman_depan/js/revolution.extension.slideanims.min.js') }}"></script>
<script src="{{ asset('halaman_depan/js/revolution.extension.video.min.js') }}"></script>
<script src="{{ asset('halaman_depan/js/slider.js') }}" type="text/javascript"></script>
<script src="{{ asset('halaman_depan/js/owl.carousel.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('halaman_depan/js/jquery.parallax-1.1.3.js') }}"></script>
<script src="{{ asset('halaman_depan/js/jquery.mixitup.min.js') }}"></script>
<script src="{{ asset('halaman_depan/js/jquery-countTo.js') }}"></script>
<script src="{{ asset('halaman_depan/js/jquery.appear.js') }}"></script>
<script src="{{ asset('halaman_depan/js/jquery.fancybox.js') }}"></script>
<script src="{{ asset('halaman_depan/js/functions.js') }}" type="text/javascript"></script>
