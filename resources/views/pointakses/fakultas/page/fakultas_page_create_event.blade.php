        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="card card-primary">
                    ...
                    <form action="{{ route('fakultas.event.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('fakultas.event')}}" class="btn btn-secondary">Kembali ke Daftar Acara</a>
                        </div>
                    </form>
                </div>
            </div>
