...
<div class="content-wrapper iframe-mode" data-widget="iframe" data-loading-screen="750">
    <div class="container mt-4">
        <!-- Simple Breadcrumb -->
        <div class="mb-3">
            <a href="{{ url('/fakultas') }}" class="text-secondary">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                @if($participant->certificate_path || isset($decryptedData['certificate_path']))
                                                    <a href="{{ route('fakultas.download.certificate', ['participant_id' => $participant->id]) }}" 
        ...
        <!-- Action Buttons -->
        <div class="mb-4">
            <a href="{{ url('/fakultas') }}" class="btn btn-secondary">
                Kembali
            </a>
...
<script>
    $(document).ready(function() {
        ...
        $('.delete-participant').click(function() {
            ...
            $('#deleteParticipantForm').attr('action', '/fakultas/participant/' + participantId);
        });
    });
</script>
@endpush
