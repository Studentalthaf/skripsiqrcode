        ...
        <div class="col-12 mt-4">
            <div class="card">
                <div class="card-header d-flex flex-column align-items-start">
                    ...
                    <a href="{{route('fakultas.create.event')}}" class="btn btn-success btn-sm">
                        Tambah Acara
                    </a>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="#">Set Placeholder</a>
                                </td>
                                <td class="text-center">
                                <a href="{{ route('fakultas.event.edit', $event->id) }}" class="btn btn-success btn-sm">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <a href="{{ route('fakultas.event.delete', $event->id) }}" class="btn btn-danger btn-sm"
